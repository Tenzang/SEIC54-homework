...
console.log(sumArray(testNumbers))
...
console.log(multiplyArray(testNumbers));
...
//adding from the 'back' of the string into result
        result += str[i];
    }
    return result;
};
